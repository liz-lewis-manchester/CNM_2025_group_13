...
- Deliverables: Function to initialise grid; coefficients A and B; function to solve the substitution
...
- Deliverables: Inflow and outflow boundary; function to load file and interpolate it 
- Person Responsible for checking: William Gardiner

*Milestone 3:Simulations*
-
- Goal: Run simulations to verify the usefulness of the code
- Task 7: Baseline simulation (Test case 1 from Coursework Brief)
- Task 8: Simulation with the initial conditions are read in from a csv file ‘initial_conditions.csv (Test case 2 from Coursework Brief)
...
- Task 10: Exponetial decay in time (Test case 4 from Coursework Brief)
- Task 11: Variable stream velocity profile (Test case 5 from Coursework Brief)
